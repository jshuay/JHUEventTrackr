...
public class WatchingDatabaseManager extends SQLiteOpenHelper {

	private static final String DB_NAME = "watching.db";
	private static final String TABLE_EVENT = "watching";
	...
	public WatchingDatabaseManager(Context context, String name,
