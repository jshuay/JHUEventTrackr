...
public class CreatedDatabaseManager extends SQLiteOpenHelper {

	private static final String DB_NAME = "created.db";
	private static final String TABLE_EVENT = "created";
	...
	public CreatedDatabaseManager(Context context, String name,
